...
# --summary/-s is parsed by test_helpers.sh
...
# worker under ~8s solo, yielding ~10-14s wall time depending on
# system load (vs ~42s sequential).
#
# Format: "<worker_id>:<test functions...>"
# ============================================
